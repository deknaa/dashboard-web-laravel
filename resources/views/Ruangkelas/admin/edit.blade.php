            ...
            <form action="{{ route('ruangkelas.update', $ruangkelas->id) }}" method="POST" enctype="multipart/form-data"
               ...
               {{-- submit button --}}
                <div class="flex items-center justify-center mt-5">
                    <button type="submit" onclick="return confirm('Apakah anda edit transaksi ini?')" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-10 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Kirim</button>
                </div>
            </form>
        </div>
    </x-dashboard.sidebar>
